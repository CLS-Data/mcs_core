...
*DACAQ_P:	DV NVQ equivalent of highest Academic qualification across previos sweeps (Partner Interviewee)
*DNVQ_P:	DV Respondent NVQ Highest Level (all sweeps- Partner Interviewee)
...
keep if ELIG00==2							 // data only from Partner of Main interview
...
rename DNVQ DNVQ_P
label var DNVQ "DV Respondent NVQ Highest Level (all sweeps- Partner Interviewee)"		  
rename DACAQ DACAQ_P
label var DACAQ "DV NVQ equivalent of highest Academic qualification across previous sweeps (Partner Interviewee)"
	
*-------------------------------------------------------------------------------
* 4) save temporal data 
* note that we don't need ELIG00 PNUM00 because it is restricted only to the derived response for the partner interview ELIG00==2
keep MCSID SWEEP DACAQ_P DNVQ_P
duplicates report MCSID SWEEP
compress
save "${temp_data_pdv}DACAQ_DNVQ_P.dta" ,replace
